...
`recycle` is a higher order function that takes a function as input, a list as input, and returns a new list where each element of the list has that function applied to it. It is properly known in Haskell as *`map`*.
